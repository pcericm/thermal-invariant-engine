...
When one zone in a group is significantly warmer than another, the fan runs to shuttle heat from the warm zone to the cold zone through the shared ductwork. This is especially valuable for capturing **free solar heat** — for example, the Living room has large south-facing windows and on a sunny afternoon it climbs to 73°F, well above its 70°F setpoint. Meanwhile the adjacent Hearth room is at 68°F and actively calling for boiler heat. The fan detects the 5°F spread and redistributes that excess solar energy from the Living room into the Hearth, reducing or eliminating the Hearth's need for boiler heat entirely. The sun is effectively heating two zones instead of one.
